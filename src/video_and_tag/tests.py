...
#         self.user = AbstractUser.objects.create_user(username='testuser', password='Yasin2324@133',
...
#     def setUp(self):
#         self.client = APIClient()
#         self.user = AbstractUser.objects.create_user(username='testuser2', password='Yasin2324@1332',
...
#                          [{'id': self.tag1.id, 'name': 'tag1'}, {'id': self.tag2.id, 'name': 'tag2'}])
#
